...
def percent_for_every_month(percent, how_long, fix_value):
    sum_value = 0
    for hl in range(1, how_long - 1):
        sum_value += fix_value * ((percent / 1200 + 1) ** hl)
    return sum_value


def bank_deposite(deposit, how_long, fix_value):
    ...
    return round(deposit * (percent / 100 / 12 * how_long + 1), 2) + \
           percent_for_every_month(percent, how_long, fix_value)


print(bank_deposite(1000, 6, 1000))
print(bank_deposite(10000, 6, 1000))
print(bank_deposite(100000, 6, 1000))
print(bank_deposite(1000000, 6, 1000))
# print(bank_deposite(1000000, 8))
# print(bank_deposite(1000001, 6, 100))
